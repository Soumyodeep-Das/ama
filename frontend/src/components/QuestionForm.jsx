...
export default function QuestionForm({ onSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white/20 p-6 rounded-2xl shadow-lg backdrop-blur-lg border border-white/20">
      ...
      <button
        type="submit"
        className="mt-4 flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-semibold shadow-md hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-all"
      >
        <span>Submit</span>
